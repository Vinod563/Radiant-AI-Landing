/**
 * staticHandler.js — Hardcoded chat responses
 * Server-side port of Deployment_vesion knowledgeBase.js + findAnswer logic.
 * Called when chatMode === 'static'. Returns same shape as LLM handler:
...
const knowledgeBase = [
  {
    ...
    cards: [
      { type: 'hero', title: brand.tagline, subtitle: brand.description, accent: '#91C46B' },
      { type: 'metrics', title: 'By the Numbers', items: heroMetrics, accent: '#596AE0' },
      { type: 'text', title: 'The Precision Context Engine', body: `${precisionContextEngine.bodyRight} ${precisionContextEngine.conclusion}`, accent: '#F0974E' },
      { type: 'pce-diagram' },
    ],
    followUp: [
    ...
    cards: [
      {
        ...
        items: solutionsData.map(s => ({
          num: s.num, title: s.title, label: s.label, accent: s.accent,
          screenshot: s.screenshot, desc: s.desc, tags: s.tags, details: s.details,
        })),
      },
    ],
    followUp: [
  ...
  },
  {
    ...
    keywords: ['enterprise icx', 'cx intelligence', 'icx platform', 'customer signals', 'churn reduction', 'nps', 'csat', 'customer satisfaction', 'net promoter', 'customer experience platform', 'icx ai'],
    question: 'Tell me about ICX AI',
    cards: [
      { type: 'hero', title: 'ICX AI: CX Intelligence Platform', subtitle: 'Unifies every customer signal into a single intelligence layer, giving your teams the predictive power to eliminate friction before it becomes churn.', accent: '#91C46B' },
      { type: 'metrics', title: 'ICX AI Impact', items: [{ value: '20%', label: 'Churn Reduction' }, { value: '94.2', label: 'CSAT Score' }, { value: '+18', label: 'NPS Improvement' }, { value: '2.1s', label: 'Avg Response Time' }], accent: '#91C46B' },
      { type: 'text', title: 'How It Works', body: 'ICX AI is powered by Semantic Data Graph, Context-Aware AI, Predictive Analytics and Time Series, and Radiant Knowledge Hub. It provides unified data across all CX touchpoints, proactive friction detection, insight-to-ROI pipeline, and real-time experience monitoring.', accent: '#91C46B' },
      { type: 'screenshot', src: '/screenshots/enterprise-icx.png', alt: 'ICX AI Dashboard', label: 'ICX AI Dashboard', accent: '#91C46B' },
    ],
    followUp: ['Tell me about Customer Journey Intelligence', 'Tell me about Anomaly Detection', 'Show me case studies', 'How does the platform work?'],
  },
  {
    ...
    cards: [
      { type: 'hero', title: 'Customer Journey Intelligence', subtitle: 'Accelerates the analysis of customer interactions across digital channels, enabling teams to visualize journeys and act on experience insights in hours, not weeks.', accent: '#F0974E' },
      { type: 'text', title: 'How It Works', body: 'Turns screen-level behavioral data into actionable journey maps using AI-powered pattern recognition and business rule mapping. Powered by Context-Aware AI, Radiant Knowledge Hub, and Semantic Data Graph.', accent: '#F0974E' },
      { type: 'screenshot', src: '/screenshots/cx-workbench.png', alt: 'Customer Journey Intelligence Dashboard', label: 'Customer Journey Intelligence', accent: '#F0974E' },
    ],
    followUp: ['Tell me about ICX AI', 'Tell me about Design-to-Code Modernization', 'Show me case studies', 'What solutions does Radiant Digital offer?'],
  },
  {
    ...
    cards: [
      { type: 'hero', title: 'Design-to-Code Modernization', subtitle: 'Transforms legacy enterprise applications into modern, design-system-compliant environments. Not wireframes in months. Working, auditable output in days per module.', accent: '#00c87d' },
      { type: 'metrics', title: 'Modernization Impact', items: [{ value: 'Days', label: 'Per Module Output' }, { value: 'Months', label: 'Reduced to Days' }, { value: '100%', label: 'Auditable Pipeline' }], accent: '#00c87d' },
      { type: 'text', title: 'How It Works', body: 'Powered by AI-RAD, Radiant Knowledge Hub, and Context-Aware AI. Analyzes legacy applications, decomposes them into modules, and generates design-system-compliant code with full audit trails.', accent: '#00c87d' },
      { type: 'screenshot', src: '/screenshots/design-to-code.png', alt: 'Design-to-Code Before and After', label: 'Legacy to Modern: Before and After', accent: '#00c87d' },
    ],
    followUp: ['Tell me about Anomaly Detection', 'Tell me about Automarc AI', 'Show me case studies', 'How does the platform work?'],
  },
  {
    id: 'sol-anomaly-detection',
    keywords: ['anomaly detection', 'anomaly', 'pattern detection', 'revenue protection', 'accuracy', 'anomalies', 'outlier detection', 'fraud detection', 'risk detection', 'revenue assurance', 'revenue leakage', 'billing intelligence', 'billing anomaly', 'billing issues'],
    question: 'Tell me about Anomaly Detection',
    cards: [
      { type: 'hero', title: 'Anomaly Detection and Proactive Risk Prevention', subtitle: 'Detects anomalies across any data stream, groups them into actionable patterns, and guides teams to resolve issues before they escalate — protecting revenue, operations, and trust at enterprise scale.', accent: '#596AE0' },
      { type: 'metrics', title: 'Anomaly Detection Impact', items: [{ value: '98%', label: 'Detection Accuracy' }, { value: '5%', label: 'Revenue Leakage Recovered' }, { value: '55%', label: 'LLM Cost Reduction' }, { value: '6 wks', label: 'To Production' }], accent: '#596AE0' },
      { type: 'text', title: 'How It Works', body: 'Powered by Predictive Analytics and Time Series, Radiant Knowledge Hub, Agentic AI and Multi-Agent Orchestration, and Semantic Data Graph. Real-time anomaly detection across billing, logistics, authentication, and operational data — with intelligent pattern grouping, guided resolution workflows, and proactive issue prevention.', accent: '#596AE0' },
      { type: 'screenshot', src: '/screenshots/anomaly-detection-v2.png', alt: 'Anomaly Detection Dashboard', label: 'Anomaly Detection', accent: '#596AE0' },
    ],
    followUp: ['Tell me about Product Launch Risk Intelligence', 'Tell me about ICX AI', 'Show me proof and case studies', 'How does the platform work?'],
  },
  {
    id: 'sol-launch-risk',
    ...
    cards: [
      { type: 'hero', title: 'Product Launch Risk Intelligence', subtitle: 'Integrates sales, returns, quality, and customer data to predict launch risk, identify root causes, and provide AI-driven go/no-go recommendations before and after launch.', accent: '#F05030' },
      { type: 'text', title: 'How It Works', body: 'Turns fragmented operational signals into a single pre-launch decision engine. Powered by Semantic Data Graph, Predictive Analytics and Time Series, Radiant Knowledge Hub, and Context-Aware AI.', accent: '#F05030' },
      { type: 'screenshot', src: '/screenshots/launch-risk-v2.png', alt: 'Product Launch Risk Intelligence', label: 'Launch Risk Analysis', accent: '#F05030' },
    ],
    followUp: ['Tell me about Automarc AI', 'Tell me about Anomaly Detection', 'Show me case studies', 'What solutions does Radiant Digital offer?'],
  },
  {
    id: 'sol-automarc',
    ...
    cards: [
      { type: 'hero', title: 'Automarc AI: Document Intelligence', subtitle: 'Extracts, classifies, and processes content to reduce manual effort and improve accuracy, turning document-heavy operations into automated, governed workflows.', accent: '#a855f7' },
      { type: 'text', title: 'How It Works', body: 'Powered by Radiant Knowledge Hub, AI-RAD, and Agentic AI and Multi-Agent Orchestration. Automates content extraction, classification, document processing workflows, and technical writing at scale.', accent: '#a855f7' },
      { type: 'screenshot', src: '/screenshots/automarc.png', alt: 'Automarc AI Dashboard', label: 'Automarc AI: Document Intelligence', accent: '#a855f7' },
    ],
    followUp: ['Tell me about ICX AI', 'Tell me about Design-to-Code Modernization', 'Show me case studies', 'How can I get started?'],
  },
  {
    ...
    cards: [
      { type: 'hero', title: 'Touchless IT Operations: Autonomous Infrastructure', subtitle: 'Shifts enterprise IT from reactive incident management to autonomous, self-healing infrastructure. Unified observability, AI-driven root cause analysis, and predictive optimization work together so your teams resolve fewer incidents manually and prevent more before they ever occur.', accent: '#2DD4BF' },
      { type: 'metrics', title: 'Touchless Operations Impact', items: [{ value: '80%', label: 'Alert Noise Reduction' }, { value: '70%', label: 'Faster Incident Resolution' }, { value: '50%', label: 'Incidents Auto-Resolved' }], accent: '#2DD4BF' },
      { type: 'text', title: 'How It Works', body: 'Powered by Radiant AIOps, Autonomous Stack, Predictive Analytics and Time Series, and Context-Aware AI. Provides end-to-end observability across infrastructure, network, and application layers. AI-driven root cause analysis identifies issues in seconds. Autonomous remediation executes runbooks automatically. Predictive optimization prevents incidents before they occur.', accent: '#2DD4BF' },
      { type: 'screenshot', src: '/screenshots/touchless-ops.png', alt: 'Touchless Operations Dashboard', label: 'Touchless Operations Command Center', accent: '#2DD4BF' },
    ],
    followUp: ['Tell me about Anomaly Detection', 'Tell me about ICX AI', 'Show me case studies', 'How does the platform work?'],
  },
  {
    id: 'case-studies',
    ...
    cards: [
      {
        ...
        items: markets.map(m => ({
          title: m.title, icon: m.icon, accent: m.accent,
          gradientFrom: m.accent + '20', gradientTo: m.accent,
          image: m.image, clients: m.clients, desc: m.desc, metrics: m.metrics,
        })),
      },
    ],
    followUp: ['What have you done for telecom?', 'What have you done for federal agencies?', 'What have you done for healthcare?', 'Show me case studies'],
  },
  {
    id: 'platform',
    keywords: ['platform', 'technology', 'architecture', 'how does it work', 'under the hood', 'framework', 'agent', 'microagent', 'agentic', 'radiant ai platform', 'what is the platform', 'tech stack', 'how is it built', 'technical capabilities', 'foundational capabilities', 'data fabric', 'finops', 'ai finops', 'knowledge hub', 'semantic graph', 'kag'],
    question: 'How does the platform work?',
    cards: [
      {
        type: 'platforms',
        title: 'Foundational capabilities. The infrastructure beneath every solution.',
        subtitle: 'Radiant Digital does not deploy generic AI. Every solution is assembled from purpose-built platform capabilities: 12 components that cover context acquisition, synthesis, grounding, reasoning, orchestration, observability, and governance.',
        items: [
          { num: '01', gradient: 'linear-gradient(135deg, #0a0a1a 0%, #0d1b3e 40%, #0a4a6e 100%)', title: 'Context and Knowledge', desc: 'The foundation layer: knowledge hubs, semantic data graphs, and context-aware AI that ensure every deployment knows your environment before it starts.', features: ['Radiant Knowledge Hub', 'Semantic Data Graph', 'KAG', 'Context-Aware AI'] },
          { num: '02', gradient: 'linear-gradient(135deg, #1a0800 0%, #3d1500 40%, #8b3000 100%)', title: 'Intelligence and Automation', desc: 'Natural language data access, orchestrated agents, and predictive analytics that turn context into action and outcomes.', features: ['Talk to Data', 'Agentic Orchestration', 'Predictive Analytics'] },
          { num: '03', gradient: 'linear-gradient(135deg, #001a00 0%, #003300 40%, #006600 100%)', title: 'Operations and Governance', desc: 'AIOps, autonomous infrastructure, data fabric, and AI FinOps: the operational layer that ensures every deployment is governed, observable, and cost-efficient.', features: ['Radiant AIOps', 'Autonomous Stack', 'Radiant Data Fabric', 'AI-RAD', 'AI FinOps'] },
        ],
      },
    ],
    followUp: ['What solutions does Radiant Digital offer?', 'How secure is Radiant Digital?', 'What technology partners power Radiant Digital?', 'Show me case studies'],
  },
  {
    id: 'infrastructure',
    ...
    followUp: ['How does the Radiant Digital AI Platform work?', 'What solutions does Radiant Digital offer?', 'How secure is Radiant Digital?', 'How can I get started?'],
  },
  {
    id: 'services',
    ...
    followUp: ['How does the Radiant Digital AI Platform work?', 'Which industries do you serve?', 'Show me case studies', 'How can I get started?'],
  },
  {
    id: 'security',
    ...
    cards: [
      { type: 'text', title: 'Governance Built In, Not Bolted On', body: `Enterprise-grade security with ${socialProof.compliance}. Every deployment includes full audit trails, human-in-the-loop oversight, and zero-trust architecture by default.`, accent: '#2DD4BF' },
      { type: 'metrics', title: 'Security and Trust', items: [{ value: socialProof.compliance.replace(' compliant', '').toUpperCase(), label: 'Defense Ready' }, { value: '99.9%', label: 'Uptime SLA' }, { value: 'Zero-Trust', label: 'Architecture' }, { value: 'Human-in-Loop', label: 'Governance' }], accent: '#2DD4BF' },
      { type: 'metrics', title: 'By the Numbers', items: trustStats.map(s => ({ value: s.value, label: s.label })), accent: '#91C46B' },
    ],
    followUp: ['What solutions does Radiant Digital offer?', 'How does the Radiant Digital AI Platform work?', 'Show me case studies', 'How can I get started?'],
  },
  {
    id: 'why-radiant',
    ...
    cards: [
      { type: 'hero', title: brand.tagline, subtitle: brand.description, accent: '#91C46B' },
      { type: 'text', title: 'The Precision Context Engine', body: `${brand.differentiator} ${precisionContextEngine.bodyRight} ${precisionContextEngine.conclusion}`, accent: '#F0974E' },
      { type: 'pce-diagram' },
      { type: 'metrics', title: 'The Proof', items: heroMetrics, accent: '#596AE0' },
    ],
    followUp: ['What solutions does Radiant Digital offer?', 'Show me case studies', 'Which industries do you serve?', 'How can I get started?'],
  },
  {
    id: 'ai-readiness',
  ...
  },
  {
    ...
    followUp: ['What is Radiant Digital?', 'What solutions does Radiant Digital offer?', 'Show me case studies', 'Why choose Radiant Digital?'],
  },
  {
    id: 'all-case-studies',
    ...
    cards: [
      { type: 'text', title: 'AI-Powered Transformation — Proof Across Industries', body: 'Radiant Digital has delivered AI-driven transformation engagements across telecom, hospitality, web services, IoT, and enterprise operations. Here are our AI case studies with measurable outcomes.', accent: '#91C46B' },
      {
        type: 'case-study-grid',
    ...
    followUp: ['What have you done for telecom?', 'Tell me about the Leading Telecom Company case study', 'What solutions does Radiant Digital offer?', 'How can I get started?'],
  },
  {
    id: 'cs-by-telecom',
    ...
    cards: [
      { type: 'text', title: 'Telecom Case Studies', body: 'Radiant Digital has mapped 20+ AI use cases across the full telecom operating model. Here are our telecom engagements:', accent: '#596AE0' },
      {
        type: 'case-study-grid',
        ...
        items: [
          ...
          { name: 'AI-Powered Network Intelligence', metric: '70% Less Dev Time', detail: '50+ screens in under 3 weeks using Design-to-Code Accelerator — IDG CIO 100 Award winner.', industry: 'Telecom', accent: '#596AE0', image: '/images/network-cables.jpg' },
          { name: 'Revenue Assurance & Billing Intelligence', metric: '5% Leakage Recovered', detail: '98% billing accuracy — revenue leakage identification and recovery.', industry: 'Telecom', accent: '#596AE0', image: '/images/analytics-dashboard.jpg' },
  ...
  },
  {
    ...
    cards: [
      { type: 'text', title: 'Federal Government Case Studies', body: 'Radiant Digital has delivered mission-critical enterprise transformation for federal agencies including DoD, HHS, DHS, Treasury, Commerce, and Interior.', accent: '#596AE0' },
      {
        type: 'case-study-grid',
  ...
  },
  {
    ...
    cards: [
      { type: 'text', title: 'State & Local Government Case Studies', body: 'Radiant Digital delivers citizen-centric transformation for state agencies. Here are our state government engagements:', accent: '#91C46B' },
      {
        type: 'case-study-grid',
  ...
  },
  {
    ...
    cards: [
      { type: 'text', title: 'Healthcare & Life Sciences Case Studies', body: 'Radiant Digital builds privacy-first digital health platforms with HIPAA governance built in. Here are our healthcare engagements:', accent: '#e05990' },
      {
        type: 'case-study-grid',
  ...
  },
  {
    ...
    cards: [
      { type: 'text', title: 'Oil & Gas Case Studies', body: 'Radiant Digital delivers connected worker safety, predictive maintenance, and digital asset intelligence for energy companies.', accent: '#F0974E' },
      {
        type: 'case-study-grid',
  ...
  },
  {
    ...
    cards: [
      { type: 'text', title: 'Financial Services Case Studies', body: 'Radiant Digital delivers AI for fraud detection, compliance automation, and customer journey transformation for financial institutions.', accent: '#F0974E' },
      {
        type: 'case-study-grid',
  ...
  {
    id: 'cs-touchless-ops',
    keywords: ['touchless operations case study', 'financial services touchless', 'autonomous operations case', 'finserv ops'],
    question: 'Tell me about the Touchless Operations case study',
    cards: [
      {
        type: 'case-study',
        title: 'Touchless Operations for Financial Services',
        subtitle: 'A leading financial services enterprise faced unsustainable operational costs driven by manual incident management, fragmented monitoring, and growing alert fatigue across its IT stack. With enterprise downtime costing over $300K per hour, the client needed to shift its operating model. Radiant Digital deployed its Touchless Operations solution combining E2E Observability with an Autonomous Stack spanning infrastructure, network, agents, applications, and data layers.',
        client: 'Leading Financial Services Enterprise',
        clientDetail: 'Financial Services',
        metrics: [{ value: '80%', label: 'Alert Noise Reduction via AI Ops' }, { value: '70%', label: 'Faster Incident Resolution' }, { value: '50%', label: 'Incidents Auto-Resolved' }, { value: '$300K+/hr', label: 'Downtime Cost Addressed' }],
    ...
    followUp: ['Tell me about the Scaling Telecom Service Capacity 5x case study', 'Show me all case studies', 'What solutions does Radiant Digital offer?', 'How can I get started?'],
  },
  {
    id: 'cs-telecom-5x',
    keywords: ['scaling telecom', 'service capacity', '5x', 'intelligent automation', 'telecom capacity', 'scaling telecom service capacity 5x', 'rpa', 'robotic process automation', 'mttr', 'scaling telecom case study', 'scaling telecom service capacity'],
    ...
    cards: [
      {
        ...
        metrics: [{ value: '5x', label: 'Service Capacity' }, { value: '18%', label: 'MTTR Reduction' }, { value: '10x', label: 'Processing Speed' }],
        accent: '#596AE0',
      },
    ],
    followUp: ['Tell me about the Improving Outage Response case study', 'Tell me about the Enabling Network Intelligence case study', 'What have you done for telecom?', 'What solutions does Radiant Digital offer?'],
  },
  {
    ...
    cards: [
      {
        ...
        client: 'Fortune 15 Telecom Company',
        clientDetail: 'Telecommunications',
        metrics: [{ value: '70%', label: 'Less Dev Time' }, { value: '50+', label: 'Screens in 3 Weeks' }, { value: '60%', label: 'Less Redundant Tasks' }],
        accent: '#596AE0',
      },
    ],
    followUp: ['Tell me about the Scaling Telecom Service Capacity 5x case study', 'Tell me about the Improving Outage Response case study', 'What have you done for telecom?', 'How can I get started?'],
  },
  {
    ...
    cards: [
      {
        ...
        subtitle: 'A Fortune 15 telecom company struggled with data sync gaps between ticketing and outage management systems, causing delayed notifications to Federal (NORS) and PSAP agencies. Radiant Digital consolidated ticketing and outage notification into a unified system, deployed AI tools with Copilot, and rebuilt the platform on MERN stack aligned with the North Star Architecture.',
        client: 'Fortune 15 Telecom Company',
        clientDetail: 'Telecommunications',
        metrics: [{ value: '40%', label: 'Faster Resolution' }, { value: '35%', label: 'Better Notification' }, { value: '45%', label: 'More Scalable' }],
        accent: '#596AE0',
      },
    ],
    followUp: ['Tell me about the Scaling Telecom Service Capacity 5x case study', 'Tell me about the Enabling Network Intelligence case study', 'What have you done for telecom?', 'How can I get started?'],
  },
  {
    id: 'cs-hospitality-ai',
    keywords: ['guest support', 'hospitality', 'virtual assistant', 'ai-powered assistant', 'rag', 'retrieval augmented generation', 'theme park'],
    ...
    cards: [
      {
        ...
        metrics: [{ value: '50%', label: 'Support Efficiency' }, { value: '35%', label: 'Guest Engagement' }, { value: '30%', label: 'Faster Dev Cycles' }],
        accent: '#F0974E',
      },
    ],
    followUp: ['Tell me about ICX AI', 'Show me all case studies', 'Which industries do you serve?', 'How can I get started?'],
  },
  {
    id: 'cs-web-modernization',
    keywords: ['modernizing digital platforms', 'web services', 'ai-accelerated delivery', 'digital platform modernization', 'ai-accelerated platform modernization', 'reverse engineering', '.net modernization', 'angular modernization'],
    ...
    cards: [
      {
        ...
        metrics: [{ value: '35%', label: 'Faster Time-to-Market' }, { value: '30%', label: 'Cost Reduction' }, { value: '40%', label: 'Less QA Effort' }],
        accent: '#91C46B',
      },
    ],
    followUp: ['Tell me about Design-to-Code Modernization', 'Show me all case studies', 'What solutions does Radiant Digital offer?', 'How can I get started?'],
  },
  {
    id: 'cs-iot-tracklynk',
    ...
    cards: [
      {
        ...
        metrics: [{ value: '60%', label: 'Faster Feature Launch' }, { value: '45%', label: 'Dev Cost Reduction' }, { value: '40%', label: 'Less Post-Prod Issues' }],
        accent: '#2DD4BF',
      },
    ],
    followUp: ['Tell me about the Halliburton case study', 'Show me all case studies', 'What have you done for oil and gas?', 'How can I get started?'],
  },
  {
    id: 'cs-quit4health',
    keywords: ['quit4health', 'quit smoking', 'smarter way to quit', 'smoking cessation'],
    ...
    cards: [
      {
        ...
        metrics: [{ value: '2.5x', label: 'Higher Quit Rate' }, { value: '85%', label: 'Daily Engagement' }, { value: '40K+', label: 'Users Enrolled' }],
        accent: '#e05990',
      },
    ],
    followUp: ['Tell me about the Brighter Bites case study', 'Tell me about the QuitBuddy case study', 'What have you done for healthcare?', 'How can I get started?'],
  },
  {
    id: 'cs-start-hiv',
    ...
    cards: [
      {
        ...
        metrics: [{ value: '88%', label: 'Adherence Rate' }, { value: '70%', label: 'Daily Engagement' }, { value: '2x', label: 'Better Outcomes' }],
        accent: '#e05990',
      },
    ],
    followUp: ['Tell me about the Brighter Bites case study', 'Tell me about the Quit4Health case study', 'What have you done for healthcare?', 'How can I get started?'],
  },
]
...
const synonyms = {
  'cost': ['price', 'expense', 'budget', 'spend', 'investment'],
  'reduce': ['cut', 'lower', 'decrease', 'minimize', 'shrink', 'trim'],
  'improve': ['enhance', 'boost', 'increase', 'optimize', 'upgrade'],
...
function expandQuery(q) {
  ...
  for (const [root, syns] of Object.entries(synonyms)) {
    for (const syn of syns) {
      if (q.includes(syn) && !q.includes(root)) expanded += ' ' + root
    }
    if (q.includes(root)) {
      for (const syn of syns) {
        if (!q.includes(syn)) expanded += ' ' + syn
      }
    }
  }
  return expanded
...
function findAnswer(query) {
  ...
  for (const entry of knowledgeBase) {
    ...
    for (const keyword of entry.keywords) {
      if (q.includes(keyword)) score += keyword.length * 1.5
      const words = keyword.split(' ')
      for (const word of words) {
        if (word.length > 4 && q.includes(word)) score += word.length * 0.4
      }
    }
    if (entry.question) {
      const entryQ = entry.question.toLowerCase()
      if (q.includes(entryQ) || entryQ.includes(raw)) score += entryQ.length * 2
    }
      ...
      cards: [
        {
          ...
          body: "I'm Radiant AI, built on a focused knowledge graph covering our solutions, case studies, platform capabilities, and the industries we serve. Try one of the topics below.",
          accent: '#596AE0',
        },
        {
          type: 'grid',
          ...
          items: [
            ...
            { icon: 'Layers', title: 'AI Solutions', accent: '#596AE0', desc: 'ICX AI, Anomaly Detection, Touchless IT Ops, and more', query: 'What solutions does Radiant Digital offer?' },
            ...
            { icon: 'Cpu', title: 'AI Platform', accent: '#596AE0', desc: 'Foundational capabilities that power every solution', query: 'How does the platform work?' },
            { icon: 'Users', title: 'Connect with Us', accent: '#F0974E', desc: 'Reach out to our team for a conversation', query: 'How can I get started?' },
          ],
        },
      ],
      followUp: [
...
/**
 * @param {string} query — already sanitized by index.js
 * @returns {{ message: string, cards: object[], followUp: string[] }}
 */
export function handleStaticChat(query) {
  const answer = findAnswer(query)
  console.log(`[Static] id: ${answer.id || 'fallback'} | ${answer.cards?.length ?? 0} cards`)
  return {
    message: '',
    cards: answer.cards || [],
