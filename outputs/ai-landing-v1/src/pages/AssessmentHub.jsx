...
const ASSESSMENTS = [
  {
    ...
    youGet: [
      ...
      "A gated full report with findings, recommended next steps, and Radiant Digital's read",
    ],
  ...
  },
  {
    ...
    youGet: [
      ...
      "Radiant Digital's Experience AI recommendation tailored to your level",
      'Relevant Radiant Digital case studies matched to your context',
    ],
