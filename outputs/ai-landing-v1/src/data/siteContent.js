...
export const aiFabric = {
  ...
  conclusion: "AI Fabric is not a product. It is the way Radiant Digital operates. Every practice runs with AI embedded: not bolted on. That is what makes Radiant Digital's enterprise transformation fundamentally faster than conventional delivery.",
  practices: [
...
// ─── SOLUTIONS ────────────────────────────────────
// Ordered by mid-market resonance (radiant-ai-landing-copy-spec §5). Each entry
// leads with `problemStatement` (buyer's voice) in the Problems We Solve accordion;
// `slug` is the deep-link hash. `num` is retained for visualOverrides/icon mapping.
export const solutions = [
  {
    ...
    tagline: 'AI-driven CX insight-to-ROI platform.',
  ...
  },
  {
    ...
    tagline: 'AI-driven document workflow automation.',
    ...
    details: [
      'AI-driven content extraction & classification',
  ...
  },
  {
    ...
    slug: 'billing',
    problemStatement: 'Billing errors generate rework and revenue loss.',
    label: 'Analytics, Data Science and AI',
    accent: '#596AE0',
    screenshot: '/screenshots/anomaly-detection-v2.png',
    tagline: 'AI-driven anomaly detection that protects revenue and operations at scale.',
  ...
  },
  {
    ...
    tags: ['Full-Stack Observability', 'Autonomous Remediation', 'Intelligent Analytics', 'Predictive Optimization'],
    platformComponents: ['Radiant AIOps', 'Autonomous Stack', 'Predictive Analytics and Time Series', 'Context-Aware AI'],
    details: [
      'Observability across infrastructure, network, and application layers',
  ...
  },
  {
    ...
    desc: 'Accelerates the analysis of customer interactions across digital channels, enabling teams to visualize journeys and act on experience insights in hours, not weeks. Turns screen-level behavioral data into actionable journey maps using AI-driven pattern recognition and business rule mapping.',
